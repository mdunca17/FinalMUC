...
public class PreviousGamesActivity extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
     ...
     // if button pressed put information for brisbane in Intent
        if (v == BrisbaneButton) {
     ...
     // if button pressed put information for edmonton in Intent
        if (v == EdmontonButton) {
     ...
     // if button pressed put information Christchurch in Intent
     ...
     // if button pressed put information for Back to glasgow in Intent
        if (v == BackToGlasgow) {
